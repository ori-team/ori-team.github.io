...
title: "oride"
description: "Detalhes, documentação e código do projeto oride."
---

import Breadcrumb from "../../components/Breadcrumb.astro";
import ProjectHeader from "../../components/ProjectHeader.astro";

<Breadcrumb trail={[{ href: "/projetos/", label: "projetos" }, { label: "oride" }]} />

<ProjectHeader slug="oride" />

**English** · [Português](https://github.com/ori-team/oride/blob/main/README.pt-BR.md)
...
Documentation: [User Guide](https://github.com/ori-team/oride/blob/main/docs/guides/en/user-guide.md) · [Architecture & Design](https://github.com/ori-team/oride/blob/main/docs/en/design.md) · [Configuration](https://github.com/ori-team/oride/blob/main/docs/guides/en/config.md) · [Themes](https://github.com/ori-team/oride/blob/main/docs/guides/en/themes.md) · [Roadmap](https://github.com/ori-team/oride/blob/main/docs/en/planning/alpha6-roadmap.md).

![Oride Interface](https://raw.githubusercontent.com/ori-team/oride/main/assets/oride-interface.png)
...
- **Supported Languages:** Rust, C, Bash, Markdown, Ori, HTML, CSS, JS/TS, Python, D (dlang), Lua, Nim, and Ruby — auto-detection, syntax highlight, comment toggling, and Markdown fence injections ([details](https://github.com/ori-team/oride/blob/main/docs/guides/en/syntax.md)).
...
- **Arch Linux:** Install via [`packaging/arch/PKGBUILD`](https://github.com/ori-team/oride/blob/main/packaging/arch/PKGBUILD) (`makepkg -si`) or pre-built `.pkg.tar.zst`.
- **Fedora / RHEL:** Build RPM via [`packaging/fedora/oride.spec`](https://github.com/ori-team/oride/blob/main/packaging/fedora/oride.spec).
- **Void Linux:** Build package via [`packaging/void/template`](https://github.com/ori-team/oride/blob/main/packaging/void/template).
...
See [`docs/guides/en/config.md`](https://github.com/ori-team/oride/blob/main/docs/guides/en/config.md) for full configuration options.
...
> For detailed technical specifications, architectural DAGs, and out-of-scope boundaries, check out the [Roadmap Specification](https://github.com/ori-team/oride/blob/main/docs/en/planning/alpha6-roadmap.md).

## Contributing

Contributions are warmly welcomed! Please see [CONTRIBUTING.md](https://github.com/ori-team/oride/blob/main/CONTRIBUTING.md) ([Português](https://github.com/ori-team/oride/blob/main/CONTRIBUTING.pt-BR.md)) for guidelines, invariants, and pull request requirements.

## License

MIT — see [LICENSE](https://github.com/ori-team/oride/blob/main/LICENSE).
