...
> For detailed technical specifications, architectural DAGs, and out-of-scope boundaries, check out the full [Roadmap Specification](https://github.com/ori-team/oride/blob/main/docs/en/planning/roadmap.md) or [ROADMAP.md](https://github.com/ori-team/oride/blob/main/ROADMAP.md).
